...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, DropdownModule, FormsModule],
    template: `
        <div class="layout-topbar">
            ...
            <div class="layout-topbar-actions">
                ...
                <div class="langButton">
                    <p-dropdown [options]="langs" [(ngModel)]="selectedLang" (onChange)="changeLang($event)"></p-dropdown>
                </div>
                ...
                <div class="layout-topbar-menu hidden lg:block">
                    <div class="layout-topbar-menu-content">
                        <button type="button" class="layout-topbar-action">
                            <i class="pi pi-user"> {{authService?.profile?.username}} </i>
                        </button>
